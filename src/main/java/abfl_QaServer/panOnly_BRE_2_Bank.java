...
public class panOnly_BRE_2_Bank {
	WebDriver driver;
	String pnumber;
	String PanNumber;
	String abfl_mail;
...
//		driver.findElement(By.id("pan")).sendKeys("PRODI0025S");

		driver.findElement(By.id("username")).sendKeys("Laxmanrao");
...
//		-------------------------------Signup 2 Page only Pan Journey ------------------
		...
		driver.findElement(By.id("entityName")).sendKeys("Laxmanrao Mohite");
...
//				.filter(consi -> consi.getText().equalsIgnoreCase("Sole Proprietorship")).findFirst().orElse(null);
...
//		Singup 3 Submit button
		...
		waits.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='p-element higher_limit_btn ml_10 ng-star-inserted']"))).click();
...
//		Thread.sleep(90000);
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[@class='accept_offer_btn higher_limit_btn']")))).click();
		
		
//		driver.findElement(By.xpath("//div[@class='accept_offer_btn higher_limit_btn']")).click();
		Thread.sleep(2000);
...
//	select Entity Address Proof Upoload ---
	...
	driver.findElement(By.xpath("(//div[@class='drop_down_option search_field_on_box ng-star-inserted'])[2]")).click();
...
//	upload address proof docucment 
	...
	driver.findElement(By.id("bussiness_address_proof_doc")).sendKeys("D:\\ownership test\\Address Proof Upload.pdf");
	Thread.sleep(2000);

//	select property ownshhip--------------------------------------------
	
	driver.findElement(By.xpath("(//label[@class='p-radiobutton-label ng-star-inserted'])[1]")).click();
	
//   Select Ownership Proof Document
	
	driver.findElement(By.xpath("(//div[@class='drop_down_option search_field_on_box ng-star-inserted'])[3]")).click();
