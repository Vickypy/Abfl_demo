...
public class uat_GST_journey {
	...
	@BeforeMethod
	public void openUrl() {
		driver.get("https://abfl-qa.credable.in/fk?code=&leadId=Fk-soleProp-testing-29-08-2023-006\r\n"
				+ "");
	}
...
//		input number
//		driver.findElement(By.id("username")).sendKeys("7721180710");
...
//		driver.findElement(By.id("pan")).sendKeys(PanNumber);//Using Random PAN
		driver.findElement(By.id("pan")).sendKeys("SOLEP0208R");
...
//			driver.findElement(By.id("udyam4")).sendKeys("0000012");
			driver.findElement(By.xpath("//button[@class='submit_btn']")).click();
			Thread.sleep(1000);
...
//		driver.findElement(By.id("proof_doc")).sendKeys("C:\\Users\\Vicky\\Documents\\EntityProofUpload\\Dec22.pdf");
//
//		Thread.sleep(2000);
////		select Entity Address Proof Upoload ---
//		driver.findElement(By.xpath("(//div[@class='drop_down_option search_field_on_box ng-star-inserted'])[5]"))
//				.click();
//		List<WebElement> addressProof = driver
//				.findElements(By.xpath("//div[@class='range__selection__option ng-star-inserted']/div"));
//		WebElement selectAddress = addressProof.stream()
//				.filter(address -> address.getText().equalsIgnoreCase("GST/VAT/CST certificate")).findFirst()
//				.orElse(null);
//		selectAddress.click();
//
////		upload address proof doucment 
//		driver.findElement(By.id("proof_address_doc"))
//				.sendKeys("C:\\Users\\Vicky\\Documents\\EntityProofUpload\\Dec22.pdf");
//		Thread.sleep(2000);
//
////		   Select Ownership Proof Document
//
//		driver.findElement(By.xpath("(//div[@class='drop_down_option search_field_on_box ng-star-inserted'])[6]"))
//				.click();
//		List<WebElement> ownerShipProof = driver
//				.findElements(By.xpath("//div[@class='range__selection__options single__selection']/div"));
//		WebElement selectOwnship = ownerShipProof.stream()
//				.filter(ownproof -> ownproof.getText().equalsIgnoreCase("Latest electricity bill")).findFirst()
//				.orElse(null);
//		selectOwnship.click();
//
////			Upload Document of Ownership proof
//
//		driver.findElement(By.id("proof_address_documnet")).sendKeys("D:\\ownership test\\Ownership Proo upload.pdf");
		Thread.sleep(2000);
